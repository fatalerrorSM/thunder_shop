...
passport.use(new LocalStrategy({usernameField : 'user_name',passwordField : 'password'},(usernameField,passwordField,done) => {
    Admin.findOne({ user_name : usernameField.toLocaleLowerCase()},(err,user : any) => {
